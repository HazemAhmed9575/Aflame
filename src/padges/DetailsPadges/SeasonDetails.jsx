  ...
  return (
    <div className="flex flex-col  gap-y-3">
      <div className="flex flex-col md:flex-row items-center p-4 bg-[#212529]">
        <img
          src={Seasons.poster_path==null?"https://www.themoviedb.org/assets/2/v4/glyphicons/basic/glyphicons-basic-38-picture-grey-c2ebdbb057f2a7614185931650f8cee23fa137b93812ccb132b9df511df1cfac.svg":`https://image.tmdb.org/t/p/w500${Seasons.poster_path}`}
